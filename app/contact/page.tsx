...
function ContactPage() {
  return (
    <div className="h-full flex flex-col-reverse lg:flex-row justify-center gap-10 md:gap-36 py-10 md:p-10">
      <RecaptchaProvider>
        <ContactForm />
      </RecaptchaProvider>
      <div className="flex flex-col gap-2 text-sm md:w-96 items-center">
